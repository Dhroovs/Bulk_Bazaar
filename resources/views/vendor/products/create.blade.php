...
<div class="space-y-10">
    ...
    <div class="flex items-center justify-between border-b border-cardBorder pb-4">
        <div>
            ...
            <p class="text-xs text-textMuted font-medium font-sans">Publish a new product node to your custom store catalog</p>
        </div>
    ...
    <!-- FORM -->
    <form action="/vendor/products/store" method="POST" enctype="multipart/form-data" class="glass-card overflow-hidden">
        @csrf
        ...
        <div class="p-6 sm:p-8 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="md:col-span-2 space-y-1.5">
                    ...
                    <input type="text" name="name" placeholder="Enter product name (e.g. Aura Smart Hub)" required
                ...
                <div class="space-y-1.5">
                    ...
                    <input type="text" name="sku" placeholder="ELEC-AURA-SH"
                ...
                <div class="space-y-1.5">
                    ...
                    <input type="number" step="0.01" name="price" placeholder="4999" required
                           class="w-full bg-bgDark border border-cardBorder rounded-xl px-4 py-2.5 text-xs text-white focus:outline-none focus:border-brandAccent focus:ring-0">
                </div>
                ...
                <div class="space-y-1.5">
                    ...
                    <input type="number" step="0.01" name="discount_price" placeholder="4299"
                           class="w-full bg-bgDark border border-cardBorder rounded-xl px-4 py-2.5 text-xs text-white focus:outline-none focus:border-brandAccent focus:ring-0">
                </div>
                ...
                <div class="space-y-1.5">
                    ...
                    <input type="text" name="brand" placeholder="Aura"
                           class="w-full bg-bgDark border border-cardBorder rounded-xl px-4 py-2.5 text-xs text-white focus:outline-none focus:border-brandAccent focus:ring-0">
                </div>
                ...
                <div class="md:col-span-3 space-y-1.5">
                    ...
                    <input type="text" name="tags" placeholder="iot, smart-hub, aura, utility"
                           class="w-full bg-bgDark border border-cardBorder rounded-xl px-4 py-2.5 text-xs text-white focus:outline-none focus:border-brandAccent focus:ring-0">
                </div>
